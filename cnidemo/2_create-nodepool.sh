...
echo "Create CNI vNext nodepool"
az network vnet subnet create -g $RG --vnet-name $VNET_NAME_CNIV2 --name $POD_SUBNET2_NAME_CNIV2 --address-prefixes 10.1.248.0/22 -o none
